...
class ToolExecutor:
    ...
    def __init__(self):
        ...
        self._aliases = {
            ...
            "web_research":          "search_google",
            "search":                "search_google",
            "internet_search":       "search_google",
            "search_web":            "search_google",
            "google_cloud_functions":"search_google",  # 3B hallucinates GCP
            "openai_chat_completion":"search_google",  # 3B hallucinates OpenAI
            "openai_search":         "search_google",
            "mlflow_tracking":       "search_google",  # 3B hallucinates MLflow
            "docker_container":      "search_google",  # 3B hallucinates Docker calls
            "api_call":              "search_google",
            "fetch_data":            "search_google",
            "get_ipl_winner":        "search_google",  # 3B hallucinates function names
            "get_news":              "search_google",
            "get_match_results":     "search_google",
            "iplay":                 "search_google",
            # Math aliases
            "math":                  "calculator",
    ...
    def _execute_fuzzy(self, llm_response: str, match) -> tuple[bool, str]:
        ...
        try:
            ...
            resolved_tool = self._aliases.get(tool_name, "search_google")
            # Try to find a query
            query = (
                tool_data.get("query", "")
